...
public partial class BloodDonationDbContext : DbContext
{
    ...
    private string GetConnectionString()
    {
        ...
        return configuration["ConnectionStrings:BloodDonationDB"];
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DonationRecord>(entity =>
        {
            ...
            entity.Property(e => e.DonorHeartRate).HasColumnName("DonorHeartRate");
            entity.Property(e => e.DonorHeight).HasColumnType("decimal(5, 2)");
